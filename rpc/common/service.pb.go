...
type Package struct {
	...
	// tri-state running-kernel flag for kernel packages
	KernelActive *bool `protobuf:"varint,24,opt,name=kernel_active,json=kernelActive,proto3,oneof" json:"kernel_active,omitempty"`
}
...
func (x *Package) GetKernelActive() bool {
	if x != nil && x.KernelActive != nil {
		return *x.KernelActive
	}
	return false
}
...
var file_rpc_common_service_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x08, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x73, 0x22, 0xe2, 0x05, 0x0a, 0x07,
	...
	0x65, 0x64, 0x42, 0x79, 0x12, 0x28, 0x0a, 0x0d, 0x6b, 0x65, 0x72, 0x6e, 0x65, 0x6c, 0x5f, 0x61,
	0x63, 0x74, 0x69, 0x76, 0x65, 0x18, 0x18, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x0c, 0x6b,
	0x65, 0x72, 0x6e, 0x65, 0x6c, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x88, 0x01, 0x01, 0x42, 0x10,
	0x0a, 0x0e, 0x5f, 0x6b, 0x65, 0x72, 0x6e, 0x65, 0x6c, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65,
...
func file_rpc_common_service_proto_init() {
	...
	file_rpc_common_service_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
